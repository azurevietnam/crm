 ...
 * @since       1.6
 */
class CrmControllerCategory extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_crm&view=categorys' . $this->getRedirectToListAppend(), false));
