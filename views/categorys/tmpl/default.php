...
<form action="<?php echo JRoute::_('index.php?option=com_crm&view=categorys'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="articleList">
				<thead>
					<tr>
						...
						<th>
							<?php echo JHtml::_('searchtools.sort', 'Tiêu đề', 'a.title', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JHtml::_('searchtools.sort', 'Thứ tự', 'a.ordering', $listDirn, $listOrder); ?>
						</th>
						<th>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
							...
							<td class="nowrap has-context">
								<a href="index.php?option=com_crm&task=category.edit&id=<?php echo $item->id;?>">
								<?php echo $item->title;?>
								</a>
							</td>
							<td class="">
