 ...
 * @since       1.6
 */
class CrmViewCategorys extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		CrmHelper::addSubmenu('categorys');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('Quản lý Danh mục Ngành nghề'), 'banners.png');
		...
		{
			JToolbarHelper::deleteList('Bạn có chắc chắn muốn xóa?', 'categorys.delete', 'Xóa');
		}
