...
<form action="<?php echo JRoute::_('index.php?option=com_crm&view=orders'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="articleList">
				<thead>
					<tr>
						...
						<th>
							<?php echo JHtml::_('searchtools.sort', 'Khách hàng', 'c.name', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JHtml::_('searchtools.sort', 'Ngày bắt đầu', 'a.start_date', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JHtml::_('searchtools.sort', 'Ngày kết thúc', 'a.end_date', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JHtml::_('searchtools.sort', 'Ngày tạo', 'a.created', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JHtml::_('searchtools.sort', 'Tạo bởi', 'a.created_by', $listDirn, $listOrder); ?>
						</th>						
						<th class="center">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
							...
							<td class="nowrap has-context">
								<a href="index.php?option=com_crm&task=order.edit&id=<?php echo $item->id;?>">
