 ...
 * @since       1.6
 */
class CrmViewOrders extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('Quản lý Đơn đặt hàng'), 'banners.png');
		...
		{
			JToolbarHelper::deleteList('Bạn có chắc chắn muốn xóa?', 'orders.delete', 'Xóa');
		}
