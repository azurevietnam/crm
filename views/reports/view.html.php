 ...
 * @since       1.6
 */
class CrmViewReports extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->expiryOrders		= $this->get('ExpiryOrders');
		$this->payments		= $this->get('Payments');
		$this->expiryPayments		= $this->get('ExpiryPayments');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('Phần mềm Quản lý Khách hàng'), 'banners.png');
		...
		{
			JToolbarHelper::deleteList('Bạn có chắc chắn muốn xóa?', 'types.delete', 'Xóa');
		} */
