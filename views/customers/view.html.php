 ...
 * @since       1.6
 */
class CrmViewCustomers extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if ($this->getLayout() != 'modal') {
			CrmHelper::addSubmenu('customers');
		}
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('Quản lý Khách hàng'), 'banners.png');
		...
		{
			JToolbarHelper::deleteList('Bạn có chắc chắn muốn xóa?', 'customers.delete', 'Xóa');
		}
