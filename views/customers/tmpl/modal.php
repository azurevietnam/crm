...
<form action="<?php echo JRoute::_('index.php?option=com_crm&view=customers&layout=modal&tmpl=component&function='.$function); ?>" method="post" name="adminForm" id="adminForm">
