...
<form action="<?php echo JRoute::_('index.php?option=com_crm&view=companys'); ?>" method="post" name="adminForm" id="adminForm">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
							...
							<td class="nowrap has-context">
								<a href="index.php?option=com_crm&task=company.edit&id=<?php echo $item->id;?>">
								<?php echo $item->title;?>
								</a>
							</td>
							<td class="">
