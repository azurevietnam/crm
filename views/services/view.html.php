 ...
 * @since       1.6
 */
class CrmViewServices extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('Quản lý Dịch vụ'), 'banners.png');
		...
		{
			JToolbarHelper::deleteList('Bạn có chắc chắn muốn xóa?', 'services.delete', 'Xóa');
		}
